...
// Package errors represents the imported interface "hayride:morph/errors@0.0.10".
package errors
...
// ErrorCode represents the enum "hayride:morph/errors@0.0.10#error-code".
//
//	enum error-code {
//		invalid-argument,
//		timeout,
...
// Error represents the imported resource "hayride:morph/errors@0.0.10#error".
//
//	resource error
...
//go:wasmimport hayride:morph/errors@0.0.10 [resource-drop]error
//go:noescape
...
//go:wasmimport hayride:morph/errors@0.0.10 [method]error.code
//go:noescape
...
//go:wasmimport hayride:morph/errors@0.0.10 [method]error.data
//go:noescape
