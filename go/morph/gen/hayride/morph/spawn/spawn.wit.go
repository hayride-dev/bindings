...
// Package spawn represents the imported interface "hayride:morph/spawn@0.0.5".
package spawn
...
// Writer represents the imported resource "hayride:morph/spawn@0.0.5#writer".
//
//	resource writer
...
//go:wasmimport hayride:morph/spawn@0.0.5 [resource-drop]writer
//go:noescape
...
//go:wasmimport hayride:morph/spawn@0.0.5 [constructor]writer
//go:noescape
...
//go:wasmimport hayride:morph/spawn@0.0.5 [method]writer.stream
//go:noescape
func wasmimport_WriterStream(self0 uint32, result *cm.Result[streams.OutputStream, streams.OutputStream, ioerror.Error])

// Reader represents the imported resource "hayride:morph/spawn@0.0.5#reader".
//
//	resource reader
...
//go:wasmimport hayride:morph/spawn@0.0.5 [resource-drop]reader
//go:noescape
...
//go:wasmimport hayride:morph/spawn@0.0.5 [constructor]reader
//go:noescape
...
//go:wasmimport hayride:morph/spawn@0.0.5 [method]reader.stream
//go:noescape
...
//go:wasmimport hayride:morph/spawn@0.0.5 exec
//go:noescape
