...
// Package types represents the imported interface "hayride:core/types@0.0.16".
package types
...
// Logging represents the record "hayride:core/types@0.0.16#logging".
//
//	record logging {
//		enabled: bool,
//		level: string,
...
// HTTP represents the record "hayride:core/types@0.0.16#http".
//
//	record http {
//		address: string,
//	}
...
// Runtime represents the record "hayride:core/types@0.0.16#runtime".
//
//	record runtime {
//		http: http,
//	}
...
// Config represents the record "hayride:core/types@0.0.16#config".
//
//	record config {
//		version: string,
//		license: string,
...
// ErrorCode represents the enum "hayride:core/types@0.0.16#error-code".
//
//	enum error-code {
//		invalid-argument,
//		runtime-error,
...
// Error represents the imported resource "hayride:core/types@0.0.16#error".
//
//	resource error
