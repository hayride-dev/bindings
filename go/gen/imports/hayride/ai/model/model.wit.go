...
// Package model represents the imported interface "hayride:ai/model@0.0.42".
package model

import (
	inferencestream "github.com/hayride-dev/bindings/go/gen/imports/hayride/ai/inference-stream"
	"github.com/hayride-dev/bindings/go/gen/imports/hayride/ai/types"
	"go.bytecodealliance.org/cm"
)

// GraphExecutionContextStream represents the imported type alias "hayride:ai/model@0.0.42#graph-execution-context-stream".
//
...
// Error represents the imported resource "hayride:ai/model@0.0.42#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.42#format".
//
//	resource format
...
// Model represents the imported resource "hayride:ai/model@0.0.42#model".
//
//	resource model
