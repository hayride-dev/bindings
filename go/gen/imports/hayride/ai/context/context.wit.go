...
// Package context represents the imported interface "hayride:ai/context@0.0.42".
package context
...
// Error represents the imported resource "hayride:ai/context@0.0.42#error".
//
//	resource error
...
// Context represents the imported resource "hayride:ai/context@0.0.42#context".
//
//	resource context
...
//
//go:nosplit
func (self Context) Next() (result cm.Result[MessageShape, Message, Error]) {
	self0 := cm.Reinterpret[uint32](self)
	wasmimport_ContextNext((uint32)(self0), &result)
	return
}
...
//
//go:nosplit
func (self Context) Push(messages cm.List[Message]) (result cm.Result[Error, struct{}, Error]) {
	self0 := cm.Reinterpret[uint32](self)
	messages0, messages1 := cm.LowerList(messages)
	wasmimport_ContextPush((uint32)(self0), (*Message)(messages0), (uint32)(messages1), &result)
	return
}
