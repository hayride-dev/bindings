...
// Package agent represents the imported interface "hayride:ai/agent@0.0.42".
package agent
...
// Message represents the type alias "hayride:ai/agent@0.0.42#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/agent@0.0.42#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/agent@0.0.42#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.42#agent".
//
//	resource agent
