...
// Package types represents the imported interface "hayride:http/types@0.0.59".
package types
...
// ErrorCode represents the enum "hayride:http/types@0.0.59#error-code".
//
//	enum error-code {
//		invalid,
//		not-found,
...
// ServerConfig represents the record "hayride:http/types@0.0.59#server-config".
//
