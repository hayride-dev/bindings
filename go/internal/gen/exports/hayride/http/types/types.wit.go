...
// Package types represents the imported interface "hayride:http/types@0.0.61".
package types
...
// ErrorCode represents the enum "hayride:http/types@0.0.61#error-code".
//
//	enum error-code {
//		invalid,
//		not-found,
...
// ServerConfig represents the record "hayride:http/types@0.0.61#server-config".
//
