...
// Package config represents the exported interface "hayride:http/config@0.0.59".
package config
...
// ServerConfig represents the type alias "hayride:http/config@0.0.59#server-config".
//
// See [types.ServerConfig] for more information.
type ServerConfig = types.ServerConfig

// ErrorCode represents the type alias "hayride:http/config@0.0.59#error-code".
//
// See [types.ErrorCode] for more information.
type ErrorCode = types.ErrorCode

// Error represents the exported resource "hayride:http/config@0.0.59#error".
//
//	resource error
