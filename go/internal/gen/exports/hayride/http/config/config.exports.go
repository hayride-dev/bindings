...
// Exports represents the caller-defined exports from "hayride:http/config@0.0.49".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:http/config@0.0.49#error".
	Error struct {
