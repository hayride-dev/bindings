...
// Exports represents the caller-defined exports from "hayride:http/config@0.0.63".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:http/config@0.0.63#error".
	Error struct {
	...
	Get func() (result cm.Result[ServerConfigShape, ServerConfig, Error])
}
