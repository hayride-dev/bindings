...
// Package auth represents the exported interface "hayride:mcp/auth@0.0.61".
package auth
...
// Error represents the exported resource "hayride:mcp/auth@0.0.61#error".
//
//	resource error
...
// Provider represents the exported resource "hayride:mcp/auth@0.0.61#provider".
//
