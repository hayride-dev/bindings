...
// Package auth represents the exported interface "hayride:mcp/auth@0.0.64".
package auth
...
// ErrorCode represents the enum "hayride:mcp/auth@0.0.64#error-code".
//
//	enum error-code {
//		auth-url-failed,
//		registration-failed,
...
// Error represents the exported resource "hayride:mcp/auth@0.0.64#error".
//
//	resource error
...
// Provider represents the exported resource "hayride:mcp/auth@0.0.64#provider".
//
