...
// Package auth represents the exported interface "hayride:mcp/auth@0.0.62".
package auth
...
// Error represents the exported resource "hayride:mcp/auth@0.0.62#error".
//
//	resource error
...
// Provider represents the exported resource "hayride:mcp/auth@0.0.62#provider".
//
