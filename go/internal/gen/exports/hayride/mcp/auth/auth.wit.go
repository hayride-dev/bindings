...
// Package auth represents the exported interface "hayride:mcp/auth@0.0.65".
package auth
...
// Error represents the exported resource "hayride:mcp/auth@0.0.65#error".
//
//	resource error
...
// Provider represents the exported resource "hayride:mcp/auth@0.0.65#provider".
//
