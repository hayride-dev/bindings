...
// Exports represents the caller-defined exports from "hayride:mcp/auth@0.0.63".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/auth@0.0.63#error".
	Error struct {
	...
	// Provider represents the caller-defined exports for resource "hayride:mcp/auth@0.0.63#provider".
	Provider struct {
