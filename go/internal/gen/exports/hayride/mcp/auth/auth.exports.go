...
// Exports represents the caller-defined exports from "hayride:mcp/auth@0.0.64".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/auth@0.0.64#error".
	Error struct {
	...
	// Provider represents the caller-defined exports for resource "hayride:mcp/auth@0.0.64#provider".
	Provider struct {
