...
//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-new]error
//go:noescape
func wasmimport_ErrorResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-rep]error
//go:noescape
func wasmimport_ErrorResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmexport hayride:mcp/auth@0.0.63#[dtor]error
//export hayride:mcp/auth@0.0.63#[dtor]error
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]error.code
//export hayride:mcp/auth@0.0.63#[method]error.code
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]error.data
//export hayride:mcp/auth@0.0.63#[method]error.data
...
//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-new]provider
//go:noescape
func wasmimport_ProviderResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-rep]provider
//go:noescape
func wasmimport_ProviderResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:mcp/auth@0.0.63 [resource-drop]provider
//go:noescape
func wasmimport_ProviderResourceDrop(self0 uint32)

//go:wasmexport hayride:mcp/auth@0.0.63#[dtor]provider
//export hayride:mcp/auth@0.0.63#[dtor]provider
...
//go:wasmexport hayride:mcp/auth@0.0.63#[constructor]provider
//export hayride:mcp/auth@0.0.63#[constructor]provider
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]provider.auth-url
//export hayride:mcp/auth@0.0.63#[method]provider.auth-url
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]provider.exchange-code
//export hayride:mcp/auth@0.0.63#[method]provider.exchange-code
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]provider.registration
//export hayride:mcp/auth@0.0.63#[method]provider.registration
...
//go:wasmexport hayride:mcp/auth@0.0.63#[method]provider.validate
//export hayride:mcp/auth@0.0.63#[method]provider.validate
