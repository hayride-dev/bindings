...
// Package types represents the imported interface "hayride:mcp/types@0.0.62".
package types
...
// ToolAnnotations represents the record "hayride:mcp/types@0.0.62#tool-annotations".
//
...
// ToolSchema represents the record "hayride:mcp/types@0.0.62#tool-schema".
//
//	record tool-schema {
//		schema-type: string,
...
// Tool represents the record "hayride:mcp/types@0.0.62#tool".
//
//	record tool {
//		name: string,
//		title: string,
...
// McpResource represents the record "hayride:mcp/types@0.0.62#mcp-resource".
//
//	record mcp-resource {
//		name: string,
//		title: string,
...
// McpResourceTemplate represents the record "hayride:mcp/types@0.0.62#mcp-resource-template".
//
...
// TextContent represents the record "hayride:mcp/types@0.0.62#text-content".
//
//	record text-content {
//		content-type: string,
//		text: string,
...
// ImageContent represents the record "hayride:mcp/types@0.0.62#image-content".
//
...
// AudioContent represents the record "hayride:mcp/types@0.0.62#audio-content".
//
...
// ResourceLinkContent represents the record "hayride:mcp/types@0.0.62#resource-link-content".
//
...
// TextResourceContents represents the record "hayride:mcp/types@0.0.62#text-resource-contents".
//
...
// BlobResourceContents represents the record "hayride:mcp/types@0.0.62#blob-resource-contents".
//
...
// ResourceContents represents the variant "hayride:mcp/types@0.0.62#resource-contents".
//
...
// EmbeddedResourceContent represents the record "hayride:mcp/types@0.0.62#embedded-resource-content".
//
...
// Content represents the variant "hayride:mcp/types@0.0.62#content".
//
...
// CallToolParams represents the record "hayride:mcp/types@0.0.62#call-tool-params".
//
...
// CallToolResult represents the record "hayride:mcp/types@0.0.62#call-tool-result".
//
...
// ListToolsResult represents the record "hayride:mcp/types@0.0.62#list-tools-result".
//
...
// PromptArgument represents the record "hayride:mcp/types@0.0.62#prompt-argument".
//
...
// Prompt represents the record "hayride:mcp/types@0.0.62#prompt".
//
//	record prompt {
//		name: string,
//		title: string,
...
// PromptRole represents the enum "hayride:mcp/types@0.0.62#prompt-role".
//
//	enum prompt-role {
//		user,
//		assistant,
...
// PromptMessage represents the record "hayride:mcp/types@0.0.62#prompt-message".
//
...
// GetPromptParams represents the record "hayride:mcp/types@0.0.62#get-prompt-params".
//
...
// GetPromptResult represents the record "hayride:mcp/types@0.0.62#get-prompt-result".
//
...
// ListPromptsResult represents the record "hayride:mcp/types@0.0.62#list-prompts-result".
//
...
// ReadResourceParams represents the record "hayride:mcp/types@0.0.62#read-resource-params".
//
...
// ReadResourceResult represents the record "hayride:mcp/types@0.0.62#read-resource-result".
//
...
// ListResourcesResult represents the record "hayride:mcp/types@0.0.62#list-resources-result".
//
...
// ListResourceTemplatesResult represents the record "hayride:mcp/types@0.0.62#list-resource-templates-result".
//
