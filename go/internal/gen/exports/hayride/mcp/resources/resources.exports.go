...
// Exports represents the caller-defined exports from "hayride:mcp/resources@0.0.65".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/resources@0.0.65#error".
	Error struct {
	...
	// Resources represents the caller-defined exports for resource "hayride:mcp/resources@0.0.65#resources".
	Resources struct {
