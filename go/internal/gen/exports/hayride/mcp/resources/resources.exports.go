...
// Exports represents the caller-defined exports from "hayride:mcp/resources@0.0.63".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/resources@0.0.63#error".
	Error struct {
	...
	// Resources represents the caller-defined exports for resource "hayride:mcp/resources@0.0.63#resources".
	Resources struct {
