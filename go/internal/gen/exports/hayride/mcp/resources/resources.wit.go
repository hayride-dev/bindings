...
// Package resources represents the exported interface "hayride:mcp/resources@0.0.63".
package resources
...
// ReadResourceParams represents the type alias "hayride:mcp/resources@0.0.63#read-resource-params".
//
// See [types.ReadResourceParams] for more information.
type ReadResourceParams = types.ReadResourceParams

// ReadResourceResult represents the type alias "hayride:mcp/resources@0.0.63#read-resource-result".
//
// See [types.ReadResourceResult] for more information.
type ReadResourceResult = types.ReadResourceResult

// ListResourcesResult represents the type alias "hayride:mcp/resources@0.0.63#list-resources-result".
//
// See [types.ListResourcesResult] for more information.
type ListResourcesResult = types.ListResourcesResult

// ListResourceTemplatesResult represents the type alias "hayride:mcp/resources@0.0.63#list-resource-templates-result".
//
...
// ErrorCode represents the enum "hayride:mcp/resources@0.0.63#error-code".
//
//	enum error-code {
...
// Error represents the exported resource "hayride:mcp/resources@0.0.63#error".
//
//	resource error
...
// Resources represents the exported resource "hayride:mcp/resources@0.0.63#resources".
//
//	resource resources
