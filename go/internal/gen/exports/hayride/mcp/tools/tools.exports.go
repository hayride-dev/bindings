...
// Exports represents the caller-defined exports from "hayride:mcp/tools@0.0.64".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/tools@0.0.64#error".
	Error struct {
	...
	// Tools represents the caller-defined exports for resource "hayride:mcp/tools@0.0.64#tools".
	Tools struct {
