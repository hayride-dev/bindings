...
// Exports represents the caller-defined exports from "hayride:mcp/tools@0.0.65".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/tools@0.0.65#error".
	Error struct {
	...
	// Tools represents the caller-defined exports for resource "hayride:mcp/tools@0.0.65#tools".
	Tools struct {
