...
// Package tools represents the exported interface "hayride:mcp/tools@0.0.63".
package tools
...
// Error represents the exported resource "hayride:mcp/tools@0.0.63#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:mcp/tools@0.0.63#tools".
//
//	resource tools
