...
// Exports represents the caller-defined exports from "hayride:mcp/prompts@0.0.61".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/prompts@0.0.61#error".
	Error struct {
