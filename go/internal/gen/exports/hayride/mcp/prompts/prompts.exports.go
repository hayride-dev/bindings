...
// Exports represents the caller-defined exports from "hayride:mcp/prompts@0.0.62".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/prompts@0.0.62#error".
	Error struct {
	...
	// Prompts represents the caller-defined exports for resource "hayride:mcp/prompts@0.0.62#prompts".
	Prompts struct {
