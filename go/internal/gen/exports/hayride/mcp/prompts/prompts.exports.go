...
// Exports represents the caller-defined exports from "hayride:mcp/prompts@0.0.63".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:mcp/prompts@0.0.63#error".
	Error struct {
	...
	// Prompts represents the caller-defined exports for resource "hayride:mcp/prompts@0.0.63#prompts".
	Prompts struct {
