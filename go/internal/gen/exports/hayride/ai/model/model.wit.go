...
// Package model represents the exported interface "hayride:ai/model@0.0.47".
package model
...
// GraphExecutionContextStream represents the exported type alias "hayride:ai/model@0.0.47#graph-execution-context-stream".
//
...
// Message represents the type alias "hayride:ai/model@0.0.47#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/model@0.0.47#error-code".
//
//	enum error-code {
//		context-error,
//		context-encode,
...
// Error represents the exported resource "hayride:ai/model@0.0.47#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.47#format".
//
//	resource format
...
// Model represents the exported resource "hayride:ai/model@0.0.47#model".
//
//	resource model
