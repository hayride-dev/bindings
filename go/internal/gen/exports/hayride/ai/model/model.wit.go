...
// Package model represents the exported interface "hayride:ai/model@0.0.52".
package model
...
// Message represents the type alias "hayride:ai/model@0.0.52#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/model@0.0.52#error-code".
//
//	enum error-code {
//		context-error,
//		context-encode,
...
// Error represents the exported resource "hayride:ai/model@0.0.52#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.52#format".
//
//	resource format
