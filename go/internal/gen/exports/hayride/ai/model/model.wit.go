...
// Package model represents the exported interface "hayride:ai/model@0.0.45".
package model
...
// GraphExecutionContextStream represents the exported type alias "hayride:ai/model@0.0.45#graph-execution-context-stream".
//
...
// Message represents the type alias "hayride:ai/model@0.0.45#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/model@0.0.45#error-code".
//
//	enum error-code {
//		context-error,
//		context-encode,
...
// Error represents the exported resource "hayride:ai/model@0.0.45#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.45#format".
//
//	resource format
...
// Model represents the exported resource "hayride:ai/model@0.0.45#model".
//
//	resource model
