...
// Package model represents the exported interface "hayride:ai/model@0.0.37".
package model
...
// GraphExecutionContextStream represents the exported type alias "hayride:ai/model@0.0.37#graph-execution-context-stream".
//
...
// OutputStream represents the exported type alias "hayride:ai/model@0.0.37#output-stream".
//
...
// Error represents the exported resource "hayride:ai/model@0.0.37#error".
//
//	resource error
...
// Model represents the exported resource "hayride:ai/model@0.0.37#model".
//
//	resource model
