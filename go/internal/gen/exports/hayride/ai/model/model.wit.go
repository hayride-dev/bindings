...
// Package model represents the exported interface "hayride:ai/model@0.0.64".
package model
...
// Message represents the type alias "hayride:ai/model@0.0.64#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/model@0.0.64#error-code".
//
//	enum error-code {
//		context-error,
//		context-encode,
...
const (
	...
	ErrorCodePartialDecode
	ErrorCodeUnknown
)

var _ErrorCodeStrings = [6]string{
	"context-error",
	"context-encode",
	"context-decode",
	"compute-error",
...
// Error represents the exported resource "hayride:ai/model@0.0.64#error".
//
//	resource error
...
// Format represents the exported resource "hayride:ai/model@0.0.64#format".
//
//	resource format
