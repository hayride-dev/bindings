...
//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-new]error
//go:noescape
func wasmimport_ErrorResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-rep]error
//go:noescape
func wasmimport_ErrorResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/model@0.0.65#[dtor]error
//export hayride:ai/model@0.0.65#[dtor]error
...
//go:wasmexport hayride:ai/model@0.0.65#[method]error.code
//export hayride:ai/model@0.0.65#[method]error.code
...
//go:wasmexport hayride:ai/model@0.0.65#[method]error.data
//export hayride:ai/model@0.0.65#[method]error.data
...
//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-new]format
//go:noescape
func wasmimport_FormatResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-rep]format
//go:noescape
func wasmimport_FormatResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/model@0.0.65 [resource-drop]format
//go:noescape
func wasmimport_FormatResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/model@0.0.65#[dtor]format
//export hayride:ai/model@0.0.65#[dtor]format
...
//go:wasmexport hayride:ai/model@0.0.65#[constructor]format
//export hayride:ai/model@0.0.65#[constructor]format
...
//go:wasmexport hayride:ai/model@0.0.65#[method]format.decode
//export hayride:ai/model@0.0.65#[method]format.decode
...
//go:wasmexport hayride:ai/model@0.0.65#[method]format.encode
//export hayride:ai/model@0.0.65#[method]format.encode
