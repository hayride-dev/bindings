...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.45".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.45#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.45#format".
	Format struct {
	...
	// Model represents the caller-defined exports for resource "hayride:ai/model@0.0.45#model".
	Model struct {
