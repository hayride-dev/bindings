...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.46".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.46#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.46#format".
	Format struct {
	...
	// Model represents the caller-defined exports for resource "hayride:ai/model@0.0.46#model".
	Model struct {
