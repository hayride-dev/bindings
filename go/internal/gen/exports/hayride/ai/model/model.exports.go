...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.40".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.40#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.40#format".
	Format struct {
	...
	// Model represents the caller-defined exports for resource "hayride:ai/model@0.0.40#model".
	Model struct {
