...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.36".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.36#error".
	Error struct {
	...
	// Model represents the caller-defined exports for resource "hayride:ai/model@0.0.36#model".
	Model struct {
