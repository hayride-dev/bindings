...
// Exports represents the caller-defined exports from "hayride:ai/model@0.0.48".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/model@0.0.48#error".
	Error struct {
	...
	// Format represents the caller-defined exports for resource "hayride:ai/model@0.0.48#format".
	Format struct {
	...
	// Model represents the caller-defined exports for resource "hayride:ai/model@0.0.48#model".
	Model struct {
