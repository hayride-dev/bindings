...
// Package agents represents the exported interface "hayride:ai/agents@0.0.62".
package agents
...
// Message represents the type alias "hayride:ai/agents@0.0.62#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Context represents the exported type alias "hayride:ai/agents@0.0.62#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the exported type alias "hayride:ai/agents@0.0.62#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the exported type alias "hayride:ai/agents@0.0.62#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// Tool represents the type alias "hayride:ai/agents@0.0.62#tool".
//
// See [types_.Tool] for more information.
type Tool = types_.Tool

// CallToolParams represents the type alias "hayride:ai/agents@0.0.62#call-tool-params".
//
// See [types_.CallToolParams] for more information.
type CallToolParams = types_.CallToolParams

// CallToolResult represents the type alias "hayride:ai/agents@0.0.62#call-tool-result".
//
// See [types_.CallToolResult] for more information.
type CallToolResult = types_.CallToolResult

// GraphStream represents the exported type alias "hayride:ai/agents@0.0.62#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// GraphExecutionContextStream represents the exported type alias "hayride:ai/agents@0.0.62#graph-execution-context-stream".
//
...
// OutputStream represents the exported type alias "hayride:ai/agents@0.0.62#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ErrorCode represents the enum "hayride:ai/agents@0.0.62#error-code".
//
//	enum error-code {
//		capabilities-error,
//		context-error,
...
// Error represents the exported resource "hayride:ai/agents@0.0.62#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agents@0.0.62#agent".
//
//	resource agent
