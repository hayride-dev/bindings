...
// Package agents represents the exported interface "hayride:ai/agents@0.0.63".
package agents
...
// Message represents the type alias "hayride:ai/agents@0.0.63#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Context represents the exported type alias "hayride:ai/agents@0.0.63#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Tools represents the exported type alias "hayride:ai/agents@0.0.63#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// Tool represents the type alias "hayride:ai/agents@0.0.63#tool".
//
// See [types_.Tool] for more information.
type Tool = types_.Tool

// CallToolParams represents the type alias "hayride:ai/agents@0.0.63#call-tool-params".
//
// See [types_.CallToolParams] for more information.
type CallToolParams = types_.CallToolParams

// CallToolResult represents the type alias "hayride:ai/agents@0.0.63#call-tool-result".
//
// See [types_.CallToolResult] for more information.
type CallToolResult = types_.CallToolResult

// ErrorCode represents the enum "hayride:ai/agents@0.0.63#error-code".
//
//	enum error-code {
//		capabilities-error,
//		context-error,
...
// Error represents the exported resource "hayride:ai/agents@0.0.63#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agents@0.0.63#agent".
//
//	resource agent
