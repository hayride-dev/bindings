...
//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-new]error
//go:noescape
func wasmimport_ErrorResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-rep]error
//go:noescape
func wasmimport_ErrorResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/agents@0.0.62#[dtor]error
//export hayride:ai/agents@0.0.62#[dtor]error
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]error.code
//export hayride:ai/agents@0.0.62#[method]error.code
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]error.data
//export hayride:ai/agents@0.0.62#[method]error.data
...
//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-new]agent
//go:noescape
func wasmimport_AgentResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-rep]agent
//go:noescape
func wasmimport_AgentResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/agents@0.0.62 [resource-drop]agent
//go:noescape
func wasmimport_AgentResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/agents@0.0.62#[dtor]agent
//export hayride:ai/agents@0.0.62#[dtor]agent
...
//go:wasmexport hayride:ai/agents@0.0.62#[constructor]agent
//export hayride:ai/agents@0.0.62#[constructor]agent
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.capabilities
//export hayride:ai/agents@0.0.62#[method]agent.capabilities
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.compute
//export hayride:ai/agents@0.0.62#[method]agent.compute
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.context
//export hayride:ai/agents@0.0.62#[method]agent.context
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.execute
//export hayride:ai/agents@0.0.62#[method]agent.execute
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.instruction
//export hayride:ai/agents@0.0.62#[method]agent.instruction
...
//go:wasmexport hayride:ai/agents@0.0.62#[method]agent.name
//export hayride:ai/agents@0.0.62#[method]agent.name
