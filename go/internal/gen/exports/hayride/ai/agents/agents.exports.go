...
// Exports represents the caller-defined exports from "hayride:ai/agents@0.0.65".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/agents@0.0.65#error".
	Error struct {
	...
	// Agent represents the caller-defined exports for resource "hayride:ai/agents@0.0.65#agent".
	Agent struct {
