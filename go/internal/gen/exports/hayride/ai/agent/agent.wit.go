...
// Package agent represents the exported interface "hayride:ai/agent@0.0.42".
package agent
...
// Error represents the exported resource "hayride:ai/agent@0.0.42#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agent@0.0.42#agent".
//
//	resource agent
