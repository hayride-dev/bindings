...
// Package agent represents the exported interface "hayride:ai/agent@0.0.43".
package agent
...
// Message represents the type alias "hayride:ai/agent@0.0.43#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/agent@0.0.43#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the exported resource "hayride:ai/agent@0.0.43#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agent@0.0.43#agent".
//
//	resource agent
