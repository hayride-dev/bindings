...
// Package agent represents the exported interface "hayride:ai/agent@0.0.46".
package agent
...
// Message represents the type alias "hayride:ai/agent@0.0.46#message".
//
// See [types.Message] for more information.
type Message = types.Message

// OutputStream represents the exported type alias "hayride:ai/agent@0.0.46#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ErrorCode represents the enum "hayride:ai/agent@0.0.46#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the exported resource "hayride:ai/agent@0.0.46#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agent@0.0.46#agent".
//
//	resource agent
