...
// Package agent represents the exported interface "hayride:ai/agent@0.0.35".
package agent
...
// OutputStream represents the exported type alias "hayride:ai/agent@0.0.35#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Message represents the type alias "hayride:ai/agent@0.0.35#message".
//
// See [model.Message] for more information.
type Message = model.Message

// ErrorCode represents the enum "hayride:ai/agent@0.0.35#error-code".
//
//	enum error-code {
//		unknown
//	}
...
// Error represents the exported resource "hayride:ai/agent@0.0.35#error".
//
//	resource error
