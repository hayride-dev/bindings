...
// Package agent represents the exported interface "hayride:ai/agent@0.0.38".
package agent
...
// OutputStream represents the exported type alias "hayride:ai/agent@0.0.38#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agent@0.0.38#error".
//
//	resource error
