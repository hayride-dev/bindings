...
// Package agent represents the exported interface "hayride:ai/agent@0.0.44".
package agent
...
// OutputStream represents the exported type alias "hayride:ai/agent@0.0.44#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agent@0.0.44#error".
//
//	resource error
...
// Agent represents the exported resource "hayride:ai/agent@0.0.44#agent".
//
//	resource agent
