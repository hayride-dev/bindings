...
// Package agent represents the exported interface "hayride:ai/agent@0.0.39".
package agent
...
// OutputStream represents the exported type alias "hayride:ai/agent@0.0.39#output-stream".
//
...
// Error represents the exported resource "hayride:ai/agent@0.0.39#error".
//
//	resource error
