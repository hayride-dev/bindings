...
// Exports represents the caller-defined exports from "hayride:ai/agent@0.0.46".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/agent@0.0.46#error".
	Error struct {
	...
	// Agent represents the caller-defined exports for resource "hayride:ai/agent@0.0.46#agent".
	Agent struct {
