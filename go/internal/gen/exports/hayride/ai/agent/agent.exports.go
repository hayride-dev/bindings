...
// Exports represents the caller-defined exports from "hayride:ai/agent@0.0.37".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/agent@0.0.37#error".
	Error struct {
