...
// Package types represents the imported interface "hayride:ai/types@0.0.64".
package types
...
// Tool represents the type alias "hayride:ai/types@0.0.64#tool".
//
// See [types.Tool] for more information.
type Tool = types.Tool

// CallToolParams represents the type alias "hayride:ai/types@0.0.64#call-tool-params".
//
// See [types.CallToolParams] for more information.
type CallToolParams = types.CallToolParams

// CallToolResult represents the type alias "hayride:ai/types@0.0.64#call-tool-result".
//
// See [types.CallToolResult] for more information.
type CallToolResult = types.CallToolResult

// Role represents the enum "hayride:ai/types@0.0.64#role".
//
//	enum role {
//		user,
//		assistant,
...
// MessageContent represents the variant "hayride:ai/types@0.0.64#message-content".
//
...
// Message represents the record "hayride:ai/types@0.0.64#message".
//
//	record message {
//		role: role,
...
// WriterType represents the enum "hayride:ai/types@0.0.64#writer-type".
//
//	enum writer-type {
//		sse,
//		raw
...
// RunnerOptions represents the record "hayride:ai/types@0.0.64#runner-options".
//
