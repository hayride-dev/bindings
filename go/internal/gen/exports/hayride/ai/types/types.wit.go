...
// Package types represents the imported interface "hayride:ai/types@0.0.36".
package types
...
// Role represents the enum "hayride:ai/types@0.0.36#role".
//
//	enum role {
//		user,
//		assistant,
...
func (e Role) String() string {
	return stringsRole[e]
}

// TextContent represents the record "hayride:ai/types@0.0.36#text-content".
//
//	record text-content {
//		text: string,
//		content-type: string,
...
// ToolSchema represents the record "hayride:ai/types@0.0.36#tool-schema".
//
//	record tool-schema {
//		id: string,
//		name: string,
...
// ToolInput represents the record "hayride:ai/types@0.0.36#tool-input".
//
//	record tool-input {
//		content-type: string,
//		id: string,
...
// ToolOutput represents the record "hayride:ai/types@0.0.36#tool-output".
//
//	record tool-output {
//		content-type: string,
//		id: string,
...
// Content represents the variant "hayride:ai/types@0.0.36#content".
//
//	variant content {
//		none,
//		text(text-content),
...
//	}
type Content cm.Variant[uint8, ToolSchemaShape, TextContent]
...
func (v Content) String() string {
	return stringsContent[v.Tag()]
}

// Message represents the record "hayride:ai/types@0.0.36#message".
//
//	record message {
//		role: role,
