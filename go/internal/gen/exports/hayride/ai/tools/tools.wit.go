...
// Package tools represents the exported interface "hayride:ai/tools@0.0.52".
package tools
...
// Error represents the exported resource "hayride:ai/tools@0.0.52#error".
//
//	resource error
...
// Tools represents the exported resource "hayride:ai/tools@0.0.52#tools".
//
//	resource tools
