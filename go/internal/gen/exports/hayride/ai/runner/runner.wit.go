...
// Package runner represents the exported interface "hayride:ai/runner@0.0.63".
package runner
...
// Agent represents the exported type alias "hayride:ai/runner@0.0.63#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// Format represents the exported type alias "hayride:ai/runner@0.0.63#format".
//
// See [model.Format] for more information.
type Format = model.Format

// OutputStream represents the exported type alias "hayride:ai/runner@0.0.63#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// TensorStream represents the exported type alias "hayride:ai/runner@0.0.63#tensor-stream".
//
// See [tensorstream.TensorStream] for more information.
type TensorStream = tensorstream.TensorStream

// GraphExecutionContextStream represents the exported type alias "hayride:ai/runner@0.0.63#graph-execution-context-stream".
//
...
// Error represents the exported resource "hayride:ai/runner@0.0.63#error".
//
//	resource error
