...
// Package runner represents the exported interface "hayride:ai/runner@0.0.62".
package runner
...
// Agent represents the exported type alias "hayride:ai/runner@0.0.62#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// OutputStream represents the exported type alias "hayride:ai/runner@0.0.62#output-stream".
//
...
// Error represents the exported resource "hayride:ai/runner@0.0.62#error".
//
//	resource error
