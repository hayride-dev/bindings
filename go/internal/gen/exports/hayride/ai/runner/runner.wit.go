...
// Package runner represents the exported interface "hayride:ai/runner@0.0.61".
package runner
...
// Agent represents the exported type alias "hayride:ai/runner@0.0.61#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// OutputStream represents the exported type alias "hayride:ai/runner@0.0.61#output-stream".
//
...
// Error represents the exported resource "hayride:ai/runner@0.0.61#error".
//
//	resource error
