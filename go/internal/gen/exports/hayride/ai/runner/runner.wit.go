...
// Package runner represents the exported interface "hayride:ai/runner@0.0.64".
package runner
...
import (
	...
	types_ "github.com/hayride-dev/bindings/go/internal/gen/exports/wasi/http/types"
	"github.com/hayride-dev/bindings/go/internal/gen/exports/wasi/io/streams"
	"go.bytecodealliance.org/cm"
)

// Message represents the type alias "hayride:ai/runner@0.0.64#message".
//
// See [types.Message] for more information.
type Message = types.Message

// RunnerOptions represents the type alias "hayride:ai/runner@0.0.64#runner-options".
//
// See [types.RunnerOptions] for more information.
type RunnerOptions = types.RunnerOptions

// Agent represents the exported type alias "hayride:ai/runner@0.0.64#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// Format represents the exported type alias "hayride:ai/runner@0.0.64#format".
//
// See [model.Format] for more information.
type Format = model.Format

// OutputStream represents the exported type alias "hayride:ai/runner@0.0.64#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// TensorStream represents the exported type alias "hayride:ai/runner@0.0.64#tensor-stream".
//
// See [tensorstream.TensorStream] for more information.
type TensorStream = tensorstream.TensorStream

// GraphExecutionContextStream represents the exported type alias "hayride:ai/runner@0.0.64#graph-execution-context-stream".
//
...
// GraphStream represents the exported type alias "hayride:ai/runner@0.0.64#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// Fields represents the exported type alias "hayride:ai/runner@0.0.64#fields".
//
// See [types_.Fields] for more information.
type Fields = types_.Fields

// ResponseOutparam represents the exported type alias "hayride:ai/runner@0.0.64#response-outparam".
//
// See [types_.ResponseOutparam] for more information.
type ResponseOutparam = types_.ResponseOutparam

// OutgoingResponse represents the exported type alias "hayride:ai/runner@0.0.64#outgoing-response".
//
// See [types_.OutgoingResponse] for more information.
type OutgoingResponse = types_.OutgoingResponse

// OutgoingBody represents the exported type alias "hayride:ai/runner@0.0.64#outgoing-body".
//
// See [types_.OutgoingBody] for more information.
type OutgoingBody = types_.OutgoingBody

// ErrorCode represents the enum "hayride:ai/runner@0.0.64#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the exported resource "hayride:ai/runner@0.0.64#error".
//
//	resource error
...
// Runner represents the exported resource "hayride:ai/runner@0.0.64#runner".
//
//	resource runner
type Runner cm.Resource

// RunnerResourceNew represents the imported resource-new for resource "runner".
//
// Creates a new resource handle.
//
//go:nosplit
func RunnerResourceNew(rep cm.Rep) (result Runner) {
	rep0 := cm.Reinterpret[uint32](rep)
	result0 := wasmimport_RunnerResourceNew((uint32)(rep0))
	result = cm.Reinterpret[Runner]((uint32)(result0))
	return
}

// ResourceRep represents the imported resource-rep for resource "runner".
//
// Returns the underlying resource representation.
//
//go:nosplit
func (self Runner) ResourceRep() (result cm.Rep) {
	self0 := cm.Reinterpret[uint32](self)
	result0 := wasmimport_RunnerResourceRep((uint32)(self0))
	result = cm.Reinterpret[cm.Rep]((uint32)(result0))
	return
}
...
func init() {
	Exports.Runner.Destructor = func(self cm.Rep) {}
}
