...
//go:wasmimport [export]hayride:ai/runner@0.0.62 [resource-new]error
//go:noescape
func wasmimport_ErrorResourceNew(rep0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/runner@0.0.62 [resource-rep]error
//go:noescape
func wasmimport_ErrorResourceRep(self0 uint32) (result0 uint32)

//go:wasmimport [export]hayride:ai/runner@0.0.62 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmexport hayride:ai/runner@0.0.62#[dtor]error
//export hayride:ai/runner@0.0.62#[dtor]error
...
//go:wasmexport hayride:ai/runner@0.0.62#[method]error.code
//export hayride:ai/runner@0.0.62#[method]error.code
...
//go:wasmexport hayride:ai/runner@0.0.62#[method]error.data
//export hayride:ai/runner@0.0.62#[method]error.data
...
//go:wasmexport hayride:ai/runner@0.0.62#invoke
//export hayride:ai/runner@0.0.62#invoke
...
//go:wasmexport hayride:ai/runner@0.0.62#invoke-stream
//export hayride:ai/runner@0.0.62#invoke-stream
