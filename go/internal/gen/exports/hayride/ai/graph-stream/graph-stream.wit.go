...
// Package graphstream represents the imported interface "hayride:ai/graph-stream@0.0.64".
package graphstream
...
// Error represents the imported type alias "hayride:ai/graph-stream@0.0.64#error".
//
// See [errors.Error] for more information.
type Error = errors.Error

// Tensor represents the imported type alias "hayride:ai/graph-stream@0.0.64#tensor".
//
// See [tensor.Tensor] for more information.
type Tensor = tensor.Tensor

// GraphExecutionContextStream represents the imported type alias "hayride:ai/graph-stream@0.0.64#graph-execution-context-stream".
//
...
// GraphStream represents the imported resource "hayride:ai/graph-stream@0.0.64#graph-stream".
//
