...
// Exports represents the caller-defined exports from "hayride:ai/context@0.0.40".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:ai/context@0.0.40#error".
	Error struct {
	...
	// Context represents the caller-defined exports for resource "hayride:ai/context@0.0.40#context".
	Context struct {
