...
// Package context represents the exported interface "hayride:ai/context@0.0.63".
package context
...
// Message represents the type alias "hayride:ai/context@0.0.63#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/context@0.0.63#error-code".
//
//	enum error-code {
...
// Error represents the exported resource "hayride:ai/context@0.0.63#error".
//
//	resource error
...
// Context represents the exported resource "hayride:ai/context@0.0.63#context".
//
//	resource context
