...
// Package context represents the exported interface "hayride:ai/context@0.0.44".
package context
...
// Message represents the type alias "hayride:ai/context@0.0.44#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/context@0.0.44#error-code".
//
//	enum error-code {
...
// Error represents the exported resource "hayride:ai/context@0.0.44#error".
//
//	resource error
...
// Context represents the exported resource "hayride:ai/context@0.0.44#context".
//
//	resource context
