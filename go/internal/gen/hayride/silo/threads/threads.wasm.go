...
//go:wasmimport hayride:silo/threads@0.0.53 [resource-drop]thread
//go:noescape
func wasmimport_ThreadResourceDrop(self0 uint32)

//go:wasmimport hayride:silo/threads@0.0.53 [method]thread.id
//go:noescape
func wasmimport_ThreadID(self0 uint32, result *cm.Result[string, string, ErrNo])

//go:wasmimport hayride:silo/threads@0.0.53 [method]thread.wait
//go:noescape
func wasmimport_ThreadWait(self0 uint32, result *cm.Result[cm.List[uint8], cm.List[uint8], ErrNo])

//go:wasmimport hayride:silo/threads@0.0.53 spawn
//go:noescape
