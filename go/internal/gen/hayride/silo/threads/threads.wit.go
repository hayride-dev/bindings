...
// Package threads represents the imported interface "hayride:silo/threads@0.0.52".
package threads
...
// ErrNo represents the u32 "hayride:silo/threads@0.0.52#err-no".
//
...
// ThreadStatus represents the enum "hayride:silo/threads@0.0.52#thread-status".
//
//	enum thread-status {
//		unknown,
//		processing,
...
// ThreadMetadata represents the record "hayride:silo/threads@0.0.52#thread-metadata".
//
...
// Thread represents the imported resource "hayride:silo/threads@0.0.52#thread".
//
//	resource thread
