...
// Package context represents the imported interface "hayride:ai/context@0.0.53".
package context
...
// Message represents the type alias "hayride:ai/context@0.0.53#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/context@0.0.53#error-code".
//
//	enum error-code {
...
// Error represents the imported resource "hayride:ai/context@0.0.53#error".
//
//	resource error
...
// Context represents the imported resource "hayride:ai/context@0.0.53#context".
//
//	resource context
