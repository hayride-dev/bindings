...
// Package tensorstream represents the imported interface "hayride:ai/tensor-stream@0.0.53".
//
...
// TensorData represents the type alias "hayride:ai/tensor-stream@0.0.53#tensor-data".
//
// See [tensor.TensorData] for more information.
type TensorData = tensor.TensorData

// TensorDimensions represents the type alias "hayride:ai/tensor-stream@0.0.53#tensor-dimensions".
//
// See [tensor.TensorDimensions] for more information.
type TensorDimensions = tensor.TensorDimensions

// TensorType represents the type alias "hayride:ai/tensor-stream@0.0.53#tensor-type".
//
// See [tensor.TensorType] for more information.
type TensorType = tensor.TensorType

// Pollable represents the imported type alias "hayride:ai/tensor-stream@0.0.53#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// StreamError represents the imported type alias "hayride:ai/tensor-stream@0.0.53#stream-error".
//
// See [streams.StreamError] for more information.
type StreamError = streams.StreamError

// TensorStream represents the imported resource "hayride:ai/tensor-stream@0.0.53#tensor-stream".
//
