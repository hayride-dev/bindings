...
// Package model represents the imported interface "hayride:ai/model@0.0.52".
package model
...
// Error represents the imported resource "hayride:ai/model@0.0.52#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.52#format".
//
//	resource format
