...
// Package model represents the imported interface "hayride:ai/model@0.0.55".
package model
...
// Error represents the imported resource "hayride:ai/model@0.0.55#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.55#format".
//
//	resource format
