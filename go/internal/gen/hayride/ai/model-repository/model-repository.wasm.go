...
//go:wasmimport hayride:ai/model-repository@0.0.57 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/model-repository@0.0.57 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/model-repository@0.0.57 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/model-repository@0.0.57 download-model
//go:noescape
func wasmimport_DownloadModel(name0 *uint8, name1 uint32, result *cm.Result[string, string, Error])

//go:wasmimport hayride:ai/model-repository@0.0.57 get-model
//go:noescape
func wasmimport_GetModel(name0 *uint8, name1 uint32, result *cm.Result[string, string, Error])

//go:wasmimport hayride:ai/model-repository@0.0.57 delete-model
//go:noescape
func wasmimport_DeleteModel(name0 *uint8, name1 uint32, result *cm.Result[Error, struct{}, Error])

//go:wasmimport hayride:ai/model-repository@0.0.57 list-models
//go:noescape
