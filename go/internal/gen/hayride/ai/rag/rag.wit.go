...
// Package rag represents the imported interface "hayride:ai/rag@0.0.55".
package rag
...
// Transformer represents the imported type alias "hayride:ai/rag@0.0.55#transformer".
//
// See [transformer.Transformer] for more information.
type Transformer = transformer.Transformer

// ErrorCode represents the enum "hayride:ai/rag@0.0.55#error-code".
//
//	enum error-code {
//		connection-failed,
//		create-table-failed,
...
// Error represents the imported resource "hayride:ai/rag@0.0.55#error".
//
//	resource error
...
// RagOption represents the tuple "hayride:ai/rag@0.0.55#rag-option".
//
//	type rag-option = tuple<string, string>
type RagOption [2]string

// Connection represents the imported resource "hayride:ai/rag@0.0.55#connection".
//
//	resource connection
