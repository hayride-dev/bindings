...
// Package tools represents the imported interface "hayride:ai/tools@0.0.54".
package tools
...
// ToolSchema represents the type alias "hayride:ai/tools@0.0.54#tool-schema".
//
// See [types.ToolSchema] for more information.
type ToolSchema = types.ToolSchema

// ToolInput represents the type alias "hayride:ai/tools@0.0.54#tool-input".
//
// See [types.ToolInput] for more information.
type ToolInput = types.ToolInput

// ToolOutput represents the type alias "hayride:ai/tools@0.0.54#tool-output".
//
// See [types.ToolOutput] for more information.
type ToolOutput = types.ToolOutput

// ErrorCode represents the enum "hayride:ai/tools@0.0.54#error-code".
//
//	enum error-code {
//		tool-call-failed,
//		tool-not-found,
...
// Error represents the imported resource "hayride:ai/tools@0.0.54#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:ai/tools@0.0.54#tools".
//
//	resource tools
