...
// Package tools represents the imported interface "hayride:ai/tools@0.0.57".
package tools
...
// Error represents the imported resource "hayride:ai/tools@0.0.57#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:ai/tools@0.0.57#tools".
//
//	resource tools
