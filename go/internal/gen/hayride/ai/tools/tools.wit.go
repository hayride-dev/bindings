...
// Package tools represents the imported interface "hayride:ai/tools@0.0.52".
package tools
...
// ToolSchema represents the type alias "hayride:ai/tools@0.0.52#tool-schema".
//
// See [types.ToolSchema] for more information.
type ToolSchema = types.ToolSchema

// ToolInput represents the type alias "hayride:ai/tools@0.0.52#tool-input".
//
// See [types.ToolInput] for more information.
type ToolInput = types.ToolInput

// ToolOutput represents the type alias "hayride:ai/tools@0.0.52#tool-output".
//
// See [types.ToolOutput] for more information.
type ToolOutput = types.ToolOutput

// ErrorCode represents the enum "hayride:ai/tools@0.0.52#error-code".
//
//	enum error-code {
//		tool-call-failed,
//		tool-not-found,
...
// Error represents the imported resource "hayride:ai/tools@0.0.52#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:ai/tools@0.0.52#tools".
//
//	resource tools
