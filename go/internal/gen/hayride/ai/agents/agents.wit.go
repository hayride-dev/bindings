...
// Package agents represents the imported interface "hayride:ai/agents@0.0.54".
package agents
...
import (
	...
	"github.com/hayride-dev/bindings/go/internal/gen/hayride/ai/tools"
...
// Message represents the type alias "hayride:ai/agents@0.0.54#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Context represents the imported type alias "hayride:ai/agents@0.0.54#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the imported type alias "hayride:ai/agents@0.0.54#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the imported type alias "hayride:ai/agents@0.0.54#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// GraphExecutionContextStream represents the imported type alias "hayride:ai/agents@0.0.54#graph-execution-context-stream".
//
...
// OutputStream represents the imported type alias "hayride:ai/agents@0.0.54#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ErrorCode represents the enum "hayride:ai/agents@0.0.54#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/agents@0.0.54#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agents@0.0.54#agent".
//
//	resource agent
...
//
//go:nosplit
func (self Agent) Invoke(input Message) (result cm.Result[MessageShape, Message, Error]) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self Agent) InvokeStream(messages Message, writer OutputStream) (result cm.Result[Error, struct{}, Error]) {
	self0 := cm.Reinterpret[uint32](self)
	messages0, messages1, messages2 := lower_Message(messages)
	writer0 := cm.Reinterpret[uint32](writer)
	wasmimport_AgentInvokeStream((uint32)(self0), (uint32)(messages0), (*types.Content)(messages1), (uint32)(messages2), (uint32)(writer0), &result)
	return
}
