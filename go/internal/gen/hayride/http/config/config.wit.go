...
// Package config represents the exported interface "hayride:http/config@0.0.57".
package config
...
// Server represents the record "hayride:http/config@0.0.57#server".
//
//	record server {
//		address: string,
//		read-timeout: u32,
...
// ErrorCode represents the enum "hayride:http/config@0.0.57#error-code".
//
//	enum error-code {
//		invalid,
//		not-found,
...
// Error represents the exported resource "hayride:http/config@0.0.57#error".
//
//	resource error
