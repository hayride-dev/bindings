...
// Package config represents the exported interface "hayride:http/config@0.0.52".
package config
...
// Server represents the record "hayride:http/config@0.0.52#server".
//
//	record server {
//		address: string,
//		read-timeout: u32,
...
// ErrorCode represents the enum "hayride:http/config@0.0.52#error-code".
//
//	enum error-code {
//		invalid,
//		not-found,
...
// Error represents the exported resource "hayride:http/config@0.0.52#error".
//
//	resource error
