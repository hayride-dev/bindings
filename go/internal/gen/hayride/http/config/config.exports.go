...
// Exports represents the caller-defined exports from "hayride:http/config@0.0.56".
var Exports struct {
	// Error represents the caller-defined exports for resource "hayride:http/config@0.0.56#error".
	Error struct {
