...
// Package wac represents the imported interface "hayride:wac/wac@0.0.58".
package wac

import (
	"github.com/hayride-dev/bindings/go/internal/gen/hayride/wac/types"
	"go.bytecodealliance.org/cm"
)

// Error represents the imported type alias "hayride:wac/wac@0.0.58#error".
//
