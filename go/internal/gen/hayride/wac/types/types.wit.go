...
// Package types represents the imported interface "hayride:wac/types@0.0.58".
package types
...
// ErrorCode represents the enum "hayride:wac/types@0.0.58#error-code".
//
//	enum error-code {
//		file-not-found,
//		resolve-failed,
...
// Error represents the imported resource "hayride:wac/types@0.0.58#error".
//
//	resource error
