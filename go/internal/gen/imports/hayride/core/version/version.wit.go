...
// Package version represents the imported interface "hayride:core/version@0.0.64".
package version
...
// ErrorCode represents the enum "hayride:core/version@0.0.64#error-code".
//
//	enum error-code {
//		get-version-failed,
//		unknown
...
const (
	ErrorCodeGetVersionFailed ErrorCode = iota
	ErrorCodeUnknown
)
...
// Error represents the imported resource "hayride:core/version@0.0.64#error".
//
//	resource error
...
// Latest represents the imported function "latest".
//
//	latest: func() -> result<string, error>
//
//go:nosplit
func Latest() (result cm.Result[string, string, Error]) {
	wasmimport_Latest(&result)
	return
}
