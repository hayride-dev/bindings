...
// Package types represents the imported interface "hayride:silo/types@0.0.64".
package types
...
// ErrNo represents the u32 "hayride:silo/types@0.0.64#err-no".
//
...
// ThreadStatus represents the enum "hayride:silo/types@0.0.64#thread-status".
//
//	enum thread-status {
//		unknown,
//		processing,
...
// ThreadMetadata represents the record "hayride:silo/types@0.0.64#thread-metadata".
//
