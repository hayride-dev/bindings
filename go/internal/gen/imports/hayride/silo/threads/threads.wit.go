...
// Package threads represents the imported interface "hayride:silo/threads@0.0.64".
package threads
...
// ErrNo represents the type alias "hayride:silo/threads@0.0.64#err-no".
//
// See [types.ErrNo] for more information.
type ErrNo = types.ErrNo

// ThreadMetadata represents the type alias "hayride:silo/threads@0.0.64#thread-metadata".
//
// See [types.ThreadMetadata] for more information.
type ThreadMetadata = types.ThreadMetadata

// ThreadStatus represents the type alias "hayride:silo/threads@0.0.64#thread-status".
//
// See [types.ThreadStatus] for more information.
type ThreadStatus = types.ThreadStatus

// Thread represents the imported resource "hayride:silo/threads@0.0.64#thread".
//
//	resource thread
