...
// This file contains wasmimport and wasmexport declarations for "hayride:silo@0.0.40".

//go:wasmimport hayride:silo/process@0.0.40 spawn
//go:noescape
func wasmimport_Spawn(path0 *uint8, path1 uint32, args0 *string, args1 uint32, result *cm.Result[int32, int32, ErrNo])

//go:wasmimport hayride:silo/process@0.0.40 wait
//go:noescape
func wasmimport_Wait(pid0 uint32, result *cm.Result[int32, int32, ErrNo])

//go:wasmimport hayride:silo/process@0.0.40 kill
//go:noescape
