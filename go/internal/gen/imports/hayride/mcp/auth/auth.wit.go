...
// Package auth represents the imported interface "hayride:mcp/auth@0.0.62".
package auth
...
// ErrorCode represents the enum "hayride:mcp/auth@0.0.62#error-code".
//
//	enum error-code {
//		auth-url-failed,
//		registration-failed,
...
// Error represents the imported resource "hayride:mcp/auth@0.0.62#error".
//
//	resource error
...
// Provider represents the imported resource "hayride:mcp/auth@0.0.62#provider".
//
