...
// Package auth represents the imported interface "hayride:mcp/auth@0.0.64".
package auth
...
// Error represents the imported resource "hayride:mcp/auth@0.0.64#error".
//
//	resource error
...
// Provider represents the imported resource "hayride:mcp/auth@0.0.64#provider".
//
