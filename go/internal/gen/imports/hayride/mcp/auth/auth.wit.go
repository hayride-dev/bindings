...
// Package auth represents the imported interface "hayride:mcp/auth@0.0.61".
package auth
...
// ErrorCode represents the enum "hayride:mcp/auth@0.0.61#error-code".
//
//	enum error-code {
//		auth-url-failed,
//		registration-failed,
...
// Error represents the imported resource "hayride:mcp/auth@0.0.61#error".
//
//	resource error
...
// Provider represents the imported resource "hayride:mcp/auth@0.0.61#provider".
//
