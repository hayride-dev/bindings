...
// Package types represents the imported interface "hayride:mcp/types@0.0.64".
package types
...
// ToolAnnotations represents the record "hayride:mcp/types@0.0.64#tool-annotations".
//
...
// ToolSchema represents the record "hayride:mcp/types@0.0.64#tool-schema".
//
//	record tool-schema {
//		schema-type: string,
...
// Tool represents the record "hayride:mcp/types@0.0.64#tool".
//
//	record tool {
//		name: string,
//		title: string,
...
// McpResource represents the record "hayride:mcp/types@0.0.64#mcp-resource".
//
//	record mcp-resource {
//		name: string,
//		title: string,
...
// McpResourceTemplate represents the record "hayride:mcp/types@0.0.64#mcp-resource-template".
//
...
// TextContent represents the record "hayride:mcp/types@0.0.64#text-content".
//
//	record text-content {
//		content-type: string,
//		text: string,
...
// ImageContent represents the record "hayride:mcp/types@0.0.64#image-content".
//
...
// AudioContent represents the record "hayride:mcp/types@0.0.64#audio-content".
//
...
// ResourceLinkContent represents the record "hayride:mcp/types@0.0.64#resource-link-content".
//
...
// TextResourceContents represents the record "hayride:mcp/types@0.0.64#text-resource-contents".
//
...
// BlobResourceContents represents the record "hayride:mcp/types@0.0.64#blob-resource-contents".
//
...
// ResourceContents represents the variant "hayride:mcp/types@0.0.64#resource-contents".
//
...
// EmbeddedResourceContent represents the record "hayride:mcp/types@0.0.64#embedded-resource-content".
//
...
// Content represents the variant "hayride:mcp/types@0.0.64#content".
//
...
// CallToolParams represents the record "hayride:mcp/types@0.0.64#call-tool-params".
//
...
// CallToolResult represents the record "hayride:mcp/types@0.0.64#call-tool-result".
//
...
// ListToolsResult represents the record "hayride:mcp/types@0.0.64#list-tools-result".
//
...
// PromptArgument represents the record "hayride:mcp/types@0.0.64#prompt-argument".
//
...
// Prompt represents the record "hayride:mcp/types@0.0.64#prompt".
//
//	record prompt {
//		name: string,
//		title: string,
...
// PromptRole represents the enum "hayride:mcp/types@0.0.64#prompt-role".
//
//	enum prompt-role {
//		user,
//		assistant,
...
// PromptMessage represents the record "hayride:mcp/types@0.0.64#prompt-message".
//
...
// GetPromptParams represents the record "hayride:mcp/types@0.0.64#get-prompt-params".
//
...
// GetPromptResult represents the record "hayride:mcp/types@0.0.64#get-prompt-result".
//
...
// ListPromptsResult represents the record "hayride:mcp/types@0.0.64#list-prompts-result".
//
...
// ReadResourceParams represents the record "hayride:mcp/types@0.0.64#read-resource-params".
//
...
// ReadResourceResult represents the record "hayride:mcp/types@0.0.64#read-resource-result".
//
...
// ListResourcesResult represents the record "hayride:mcp/types@0.0.64#list-resources-result".
//
...
// ListResourceTemplatesResult represents the record "hayride:mcp/types@0.0.64#list-resource-templates-result".
//
