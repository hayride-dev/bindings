...
// Package tools represents the imported interface "hayride:mcp/tools@0.0.65".
package tools
...
// Error represents the imported resource "hayride:mcp/tools@0.0.65#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:mcp/tools@0.0.65#tools".
//
//	resource tools
