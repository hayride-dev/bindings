...
// Package tools represents the imported interface "hayride:mcp/tools@0.0.63".
package tools
...
// CallToolParams represents the type alias "hayride:mcp/tools@0.0.63#call-tool-params".
//
// See [types.CallToolParams] for more information.
type CallToolParams = types.CallToolParams

// CallToolResult represents the type alias "hayride:mcp/tools@0.0.63#call-tool-result".
//
// See [types.CallToolResult] for more information.
type CallToolResult = types.CallToolResult

// ListToolsResult represents the type alias "hayride:mcp/tools@0.0.63#list-tools-result".
//
// See [types.ListToolsResult] for more information.
type ListToolsResult = types.ListToolsResult

// ErrorCode represents the enum "hayride:mcp/tools@0.0.63#error-code".
//
//	enum error-code {
//		tool-call-failed,
//		tool-not-found,
...
// Error represents the imported resource "hayride:mcp/tools@0.0.63#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:mcp/tools@0.0.63#tools".
//
//	resource tools
