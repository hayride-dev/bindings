...
// Package tools represents the imported interface "hayride:mcp/tools@0.0.62".
package tools
...
// Error represents the imported resource "hayride:mcp/tools@0.0.62#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:mcp/tools@0.0.62#tools".
//
//	resource tools
