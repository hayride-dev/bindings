...
// Package tools represents the imported interface "hayride:mcp/tools@0.0.64".
package tools
...
// Error represents the imported resource "hayride:mcp/tools@0.0.64#error".
//
//	resource error
...
// Tools represents the imported resource "hayride:mcp/tools@0.0.64#tools".
//
//	resource tools
