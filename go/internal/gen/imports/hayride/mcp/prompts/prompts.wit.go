...
// Package prompts represents the imported interface "hayride:mcp/prompts@0.0.62".
package prompts
...
// GetPromptParams represents the type alias "hayride:mcp/prompts@0.0.62#get-prompt-params".
//
// See [types.GetPromptParams] for more information.
type GetPromptParams = types.GetPromptParams

// GetPromptResult represents the type alias "hayride:mcp/prompts@0.0.62#get-prompt-result".
//
// See [types.GetPromptResult] for more information.
type GetPromptResult = types.GetPromptResult

// ListPromptsResult represents the type alias "hayride:mcp/prompts@0.0.62#list-prompts-result".
//
// See [types.ListPromptsResult] for more information.
type ListPromptsResult = types.ListPromptsResult

// ErrorCode represents the enum "hayride:mcp/prompts@0.0.62#error-code".
//
//	enum error-code {
//		prompt-list-failed,
//		prompt-not-found,
...
// Error represents the imported resource "hayride:mcp/prompts@0.0.62#error".
//
//	resource error
...
// Prompts represents the imported resource "hayride:mcp/prompts@0.0.62#prompts".
//
//	resource prompts
