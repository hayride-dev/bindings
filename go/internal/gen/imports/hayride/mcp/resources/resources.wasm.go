...
//go:wasmimport hayride:mcp/resources@0.0.64 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.64 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.64 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:mcp/resources@0.0.64 [resource-drop]resources
//go:noescape
func wasmimport_ResourcesResourceDrop(self0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.64 [constructor]resources
//go:noescape
func wasmimport_NewResources() (result0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.64 [method]resources.list-resources
//go:noescape
...
//go:wasmimport hayride:mcp/resources@0.0.64 [method]resources.list-templates
//go:noescape
...
//go:wasmimport hayride:mcp/resources@0.0.64 [method]resources.read-resources
//go:noescape
