...
//go:wasmimport hayride:mcp/resources@0.0.65 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.65 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.65 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:mcp/resources@0.0.65 [resource-drop]resources
//go:noescape
func wasmimport_ResourcesResourceDrop(self0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.65 [constructor]resources
//go:noescape
func wasmimport_NewResources() (result0 uint32)

//go:wasmimport hayride:mcp/resources@0.0.65 [method]resources.list-resources
//go:noescape
...
//go:wasmimport hayride:mcp/resources@0.0.65 [method]resources.list-templates
//go:noescape
...
//go:wasmimport hayride:mcp/resources@0.0.65 [method]resources.read-resources
//go:noescape
