...
// Package modelrepository represents the imported interface "hayride:ai/model-repository@0.0.60".
...
// ErrorCode represents the enum "hayride:ai/model-repository@0.0.60#error-code".
//
//	enum error-code {
//		model-not-found,
//		invalid-model-name,
...
// Error represents the imported resource "hayride:ai/model-repository@0.0.60#error".
//
//	resource error
