...
// Package modelrepository represents the imported interface "hayride:ai/model-repository@0.0.65".
...
// ErrorCode represents the enum "hayride:ai/model-repository@0.0.65#error-code".
//
//	enum error-code {
//		model-not-found,
//		invalid-model-name,
...
// Error represents the imported resource "hayride:ai/model-repository@0.0.65#error".
//
//	resource error
