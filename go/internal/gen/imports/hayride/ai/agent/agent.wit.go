...
// Package agent represents the imported interface "hayride:ai/agent@0.0.37".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.37#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agent@0.0.37#error".
//
//	resource error
