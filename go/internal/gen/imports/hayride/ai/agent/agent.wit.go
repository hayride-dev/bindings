...
// Package agent represents the imported interface "hayride:ai/agent@0.0.35".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.35#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agent@0.0.35#error".
//
//	resource error
