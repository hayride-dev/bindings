...
// Package agent represents the imported interface "hayride:ai/agent@0.0.50".
package agent
...
// Message represents the type alias "hayride:ai/agent@0.0.50#message".
//
// See [types.Message] for more information.
type Message = types.Message

// OutputStream represents the imported type alias "hayride:ai/agent@0.0.50#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ErrorCode represents the enum "hayride:ai/agent@0.0.50#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/agent@0.0.50#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.50#agent".
//
//	resource agent
