...
// Package agent represents the imported interface "hayride:ai/agent@0.0.40".
package agent
...
// Context represents the imported type alias "hayride:ai/agent@0.0.40#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Message represents the type alias "hayride:ai/agent@0.0.40#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Model represents the imported type alias "hayride:ai/agent@0.0.40#model".
//
// See [model.Model] for more information.
type Model = model.Model

// ErrorCode represents the enum "hayride:ai/agent@0.0.40#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/agent@0.0.40#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.40#agent".
//
//	resource agent
...
//
//go:nosplit
func NewAgent(name string, instruction string) (result Agent) {
	name0, name1 := cm.LowerString(name)
	instruction0, instruction1 := cm.LowerString(instruction)
	result0 := wasmimport_NewAgent((*uint8)(name0), (uint32)(name1), (*uint8)(instruction0), (uint32)(instruction1))
