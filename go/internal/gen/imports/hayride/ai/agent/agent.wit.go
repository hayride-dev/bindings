...
// Package agent represents the imported interface "hayride:ai/agent@0.0.43".
package agent
...
// Error represents the imported resource "hayride:ai/agent@0.0.43#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.43#agent".
//
//	resource agent
