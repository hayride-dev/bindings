...
// Package agent represents the imported interface "hayride:ai/agent@0.0.48".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.48#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agent@0.0.48#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.48#agent".
//
//	resource agent
