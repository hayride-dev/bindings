...
// Package agent represents the imported interface "hayride:ai/agent@0.0.49".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.49#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agent@0.0.49#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.49#agent".
//
//	resource agent
