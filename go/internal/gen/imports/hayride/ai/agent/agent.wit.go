...
// Package agent represents the imported interface "hayride:ai/agent@0.0.47".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.47#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agent@0.0.47#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agent@0.0.47#agent".
//
//	resource agent
