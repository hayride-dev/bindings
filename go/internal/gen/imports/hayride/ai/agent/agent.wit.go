...
// Package agent represents the imported interface "hayride:ai/agent@0.0.39".
package agent
...
// OutputStream represents the imported type alias "hayride:ai/agent@0.0.39#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Message represents the type alias "hayride:ai/agent@0.0.39#message".
//
// See [model.Message] for more information.
type Message = model.Message

// ErrorCode represents the enum "hayride:ai/agent@0.0.39#error-code".
//
//	enum error-code {
//		unknown
//	}
...
// Error represents the imported resource "hayride:ai/agent@0.0.39#error".
//
//	resource error
