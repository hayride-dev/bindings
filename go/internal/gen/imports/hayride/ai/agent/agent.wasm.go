...
//go:wasmimport hayride:ai/agent@0.0.50 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/agent@0.0.50 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/agent@0.0.50 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/agent@0.0.50 [resource-drop]agent
//go:noescape
func wasmimport_AgentResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/agent@0.0.50 [constructor]agent
//go:noescape
func wasmimport_NewAgent() (result0 uint32)

//go:wasmimport hayride:ai/agent@0.0.50 [method]agent.invoke
//go:noescape
...
//go:wasmimport hayride:ai/agent@0.0.50 [method]agent.invoke-stream
//go:noescape
