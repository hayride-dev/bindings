...
//go:wasmimport hayride:ai/tensor-stream@0.0.45 [resource-drop]tensor-stream
//go:noescape
func wasmimport_TensorStreamResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/tensor-stream@0.0.45 [constructor]tensor-stream
//go:noescape
func wasmimport_NewTensorStream(dimensions0 *uint32, dimensions1 uint32, ty0 uint32, data0 *uint8, data1 uint32) (result0 uint32)

//go:wasmimport hayride:ai/tensor-stream@0.0.45 [method]tensor-stream.dimensions
//go:noescape
func wasmimport_TensorStreamDimensions(self0 uint32, result *TensorDimensions)

//go:wasmimport hayride:ai/tensor-stream@0.0.45 [method]tensor-stream.read
//go:noescape
func wasmimport_TensorStreamRead(self0 uint32, len0 uint64, result *cm.Result[TensorData, TensorData, StreamError])

//go:wasmimport hayride:ai/tensor-stream@0.0.45 [method]tensor-stream.subscribe
//go:noescape
func wasmimport_TensorStreamSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/tensor-stream@0.0.45 [method]tensor-stream.ty
//go:noescape
