...
// Package tensorstream represents the imported interface "hayride:ai/tensor-stream@0.0.35".
//
// This interface defines a stream of tensors. The stream is a sequence of tensors.
package tensorstream

import (
	"github.com/hayride-dev/bindings/go/internal/gen/imports/wasi/io/poll"
...
// TensorData represents the type alias "hayride:ai/tensor-stream@0.0.35#tensor-data".
//
// See [tensor.TensorData] for more information.
type TensorData = tensor.TensorData

// TensorDimensions represents the type alias "hayride:ai/tensor-stream@0.0.35#tensor-dimensions".
//
// See [tensor.TensorDimensions] for more information.
type TensorDimensions = tensor.TensorDimensions

// TensorType represents the type alias "hayride:ai/tensor-stream@0.0.35#tensor-type".
//
// See [tensor.TensorType] for more information.
type TensorType = tensor.TensorType

// Pollable represents the imported type alias "hayride:ai/tensor-stream@0.0.35#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// StreamError represents the imported type alias "hayride:ai/tensor-stream@0.0.35#stream-error".
//
// See [streams.StreamError] for more information.
type StreamError = streams.StreamError

// TensorStream represents the imported resource "hayride:ai/tensor-stream@0.0.35#tensor-stream".
//
...
//
//go:nosplit
func (self TensorStream) Read(len_ uint64) (result cm.Result[tensor.TensorData, TensorData, StreamError]) {
	self0 := cm.Reinterpret[uint32](self)
	len0 := (uint64)(len_)
