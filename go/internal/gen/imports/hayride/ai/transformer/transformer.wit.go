...
// Package transformer represents the imported interface "hayride:ai/transformer@0.0.48".
package transformer
...
// EmbeddingType represents the enum "hayride:ai/transformer@0.0.48#embedding-type".
//
//	enum embedding-type {
//		sentence
//	}
...
// Transformer represents the imported resource "hayride:ai/transformer@0.0.48#transformer".
//
