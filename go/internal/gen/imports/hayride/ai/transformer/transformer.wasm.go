...
//go:wasmimport hayride:ai/transformer@0.0.36 [resource-drop]transformer
//go:noescape
func wasmimport_TransformerResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/transformer@0.0.36 [constructor]transformer
//go:noescape
...
//go:wasmimport hayride:ai/transformer@0.0.36 [method]transformer.data-column
//go:noescape
func wasmimport_TransformerDataColumn(self0 uint32, result *string)

//go:wasmimport hayride:ai/transformer@0.0.36 [method]transformer.embedding
//go:noescape
func wasmimport_TransformerEmbedding(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/transformer@0.0.36 [method]transformer.model
//go:noescape
func wasmimport_TransformerModel(self0 uint32, result *string)

//go:wasmimport hayride:ai/transformer@0.0.36 [method]transformer.vector-column
//go:noescape
