...
//go:wasmimport hayride:ai/rag@0.0.62 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/rag@0.0.62 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/rag@0.0.62 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/rag@0.0.62 [resource-drop]connection
//go:noescape
func wasmimport_ConnectionResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/rag@0.0.62 [method]connection.embed
//go:noescape
...
//go:wasmimport hayride:ai/rag@0.0.62 [method]connection.query
//go:noescape
...
//go:wasmimport hayride:ai/rag@0.0.62 [method]connection.register
//go:noescape
func wasmimport_ConnectionRegister(self0 uint32, transformer0 uint32, result *cm.Result[Error, struct{}, Error])

//go:wasmimport hayride:ai/rag@0.0.62 connect
//go:noescape
