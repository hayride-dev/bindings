...
// Package context represents the imported interface "hayride:ai/context@0.0.63".
package context
...
// Error represents the imported resource "hayride:ai/context@0.0.63#error".
//
//	resource error
...
// Context represents the imported resource "hayride:ai/context@0.0.63#context".
//
//	resource context
...
func (self Context) Push(msg Message) (result cm.Result[Error, struct{}, Error]) {
	...
	wasmimport_ContextPush((uint32)(self0), (uint32)(msg0), (*types.MessageContent)(msg1), (uint32)(msg2), (uint32)(msg3), &result)
	return
}
