...
// Package context represents the imported interface "hayride:ai/context@0.0.60".
package context
...
// Message represents the type alias "hayride:ai/context@0.0.60#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/context@0.0.60#error-code".
//
//	enum error-code {
...
// Error represents the imported resource "hayride:ai/context@0.0.60#error".
//
//	resource error
...
// Context represents the imported resource "hayride:ai/context@0.0.60#context".
//
//	resource context
