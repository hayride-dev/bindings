...
// Package runner represents the imported interface "hayride:ai/runner@0.0.64".
package runner
...
// Agent represents the imported type alias "hayride:ai/runner@0.0.64#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// Format represents the imported type alias "hayride:ai/runner@0.0.64#format".
//
// See [model.Format] for more information.
type Format = model.Format

// OutputStream represents the imported type alias "hayride:ai/runner@0.0.64#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// TensorStream represents the imported type alias "hayride:ai/runner@0.0.64#tensor-stream".
//
// See [tensorstream.TensorStream] for more information.
type TensorStream = tensorstream.TensorStream

// GraphExecutionContextStream represents the imported type alias "hayride:ai/runner@0.0.64#graph-execution-context-stream".
//
...
// GraphStream represents the imported type alias "hayride:ai/runner@0.0.64#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// Fields represents the imported type alias "hayride:ai/runner@0.0.64#fields".
//
// See [types_.Fields] for more information.
type Fields = types_.Fields

// ResponseOutparam represents the imported type alias "hayride:ai/runner@0.0.64#response-outparam".
//
// See [types_.ResponseOutparam] for more information.
type ResponseOutparam = types_.ResponseOutparam

// OutgoingResponse represents the imported type alias "hayride:ai/runner@0.0.64#outgoing-response".
//
// See [types_.OutgoingResponse] for more information.
type OutgoingResponse = types_.OutgoingResponse

// OutgoingBody represents the imported type alias "hayride:ai/runner@0.0.64#outgoing-body".
//
...
// Error represents the imported resource "hayride:ai/runner@0.0.64#error".
//
//	resource error
...
// Runner represents the imported resource "hayride:ai/runner@0.0.64#runner".
//
//	resource runner
