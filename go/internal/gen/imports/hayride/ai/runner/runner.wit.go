...
// Package runner represents the imported interface "hayride:ai/runner@0.0.63".
package runner
...
// Message represents the type alias "hayride:ai/runner@0.0.63#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Agent represents the imported type alias "hayride:ai/runner@0.0.63#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// Format represents the imported type alias "hayride:ai/runner@0.0.63#format".
//
// See [model.Format] for more information.
type Format = model.Format

// OutputStream represents the imported type alias "hayride:ai/runner@0.0.63#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// TensorStream represents the imported type alias "hayride:ai/runner@0.0.63#tensor-stream".
//
// See [tensorstream.TensorStream] for more information.
type TensorStream = tensorstream.TensorStream

// GraphExecutionContextStream represents the imported type alias "hayride:ai/runner@0.0.63#graph-execution-context-stream".
//
...
// ErrorCode represents the enum "hayride:ai/runner@0.0.63#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/runner@0.0.63#error".
//
//	resource error
...
//
//go:nosplit
func Invoke(message Message, agent Agent, format Format, graph GraphExecutionContextStream, outputStream cm.Option[OutputStream]) (result cm.Result[cm.List[Message], cm.List[Message], Error]) {
	...
	wasmimport_Invoke((uint32)(message0), (*types.MessageContent)(message1), (uint32)(message2), (uint32)(message3), (uint32)(agent0), (uint32)(format0), (uint32)(graph0), (uint32)(outputStream0), (uint32)(outputStream1), &result)
	return
}
