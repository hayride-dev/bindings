...
// Package runner represents the imported interface "hayride:ai/runner@0.0.62".
package runner
...
// Message represents the type alias "hayride:ai/runner@0.0.62#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Agent represents the imported type alias "hayride:ai/runner@0.0.62#agent".
//
// See [agents.Agent] for more information.
type Agent = agents.Agent

// OutputStream represents the imported type alias "hayride:ai/runner@0.0.62#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// ErrorCode represents the enum "hayride:ai/runner@0.0.62#error-code".
//
//	enum error-code {
//		invoke-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/runner@0.0.62#error".
//
//	resource error
