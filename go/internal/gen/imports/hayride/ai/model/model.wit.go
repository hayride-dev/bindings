...
// Package model represents the imported interface "hayride:ai/model@0.0.49".
package model
...
// GraphExecutionContextStream represents the imported type alias "hayride:ai/model@0.0.49#graph-execution-context-stream".
//
...
// Error represents the imported resource "hayride:ai/model@0.0.49#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.49#format".
//
//	resource format
...
// Model represents the imported resource "hayride:ai/model@0.0.49#model".
//
//	resource model
