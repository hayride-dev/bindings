...
// Package model represents the imported interface "hayride:ai/model@0.0.59".
package model
...
// Message represents the type alias "hayride:ai/model@0.0.59#message".
//
// See [types.Message] for more information.
type Message = types.Message

// ErrorCode represents the enum "hayride:ai/model@0.0.59#error-code".
//
//	enum error-code {
//		context-error,
//		context-encode,
...
// Error represents the imported resource "hayride:ai/model@0.0.59#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.59#format".
//
//	resource format
