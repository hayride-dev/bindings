...
// Package model represents the imported interface "hayride:ai/model@0.0.63".
package model
...
// Error represents the imported resource "hayride:ai/model@0.0.63#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.63#format".
//
//	resource format
