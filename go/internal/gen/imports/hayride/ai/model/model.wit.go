...
// Package model represents the imported interface "hayride:ai/model@0.0.38".
package model
...
// GraphExecutionContextStream represents the imported type alias "hayride:ai/model@0.0.38#graph-execution-context-stream".
//
...
// OutputStream represents the imported type alias "hayride:ai/model@0.0.38#output-stream".
//
...
// Error represents the imported resource "hayride:ai/model@0.0.38#error".
//
//	resource error
...
// Model represents the imported resource "hayride:ai/model@0.0.38#model".
//
//	resource model
