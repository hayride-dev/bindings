...
// Package model represents the imported interface "hayride:ai/model@0.0.65".
package model
...
// Error represents the imported resource "hayride:ai/model@0.0.65#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.65#format".
//
//	resource format
