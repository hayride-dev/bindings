...
// Package model represents the imported interface "hayride:ai/model@0.0.48".
package model
...
// GraphExecutionContextStream represents the imported type alias "hayride:ai/model@0.0.48#graph-execution-context-stream".
//
...
// Error represents the imported resource "hayride:ai/model@0.0.48#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.48#format".
//
//	resource format
...
// Model represents the imported resource "hayride:ai/model@0.0.48#model".
//
//	resource model
