...
// Package model represents the imported interface "hayride:ai/model@0.0.43".
package model
...
// GraphExecutionContextStream represents the imported type alias "hayride:ai/model@0.0.43#graph-execution-context-stream".
//
...
// Error represents the imported resource "hayride:ai/model@0.0.43#error".
//
//	resource error
...
// Format represents the imported resource "hayride:ai/model@0.0.43#format".
//
//	resource format
...
// Model represents the imported resource "hayride:ai/model@0.0.43#model".
//
//	resource model
