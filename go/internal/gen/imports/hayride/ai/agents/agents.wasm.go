...
//go:wasmimport hayride:ai/agents@0.0.64 [resource-drop]error
//go:noescape
func wasmimport_ErrorResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/agents@0.0.64 [method]error.code
//go:noescape
func wasmimport_ErrorCode(self0 uint32) (result0 uint32)

//go:wasmimport hayride:ai/agents@0.0.64 [method]error.data
//go:noescape
func wasmimport_ErrorData(self0 uint32, result *string)

//go:wasmimport hayride:ai/agents@0.0.64 [resource-drop]agent
//go:noescape
func wasmimport_AgentResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/agents@0.0.64 [constructor]agent
//go:noescape
...
//go:wasmimport hayride:ai/agents@0.0.64 [method]agent.instruction
//go:noescape
func wasmimport_AgentInstruction(self0 uint32, result *string)

//go:wasmimport hayride:ai/agents@0.0.64 [method]agent.name
//go:noescape
func wasmimport_AgentName(self0 uint32, result *string)

//go:wasmimport hayride:ai/agents@0.0.64 [method]agent.push
//go:noescape
