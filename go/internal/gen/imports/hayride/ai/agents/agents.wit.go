...
// Package agents represents the imported interface "hayride:ai/agents@0.0.60".
package agents
...
// Context represents the imported type alias "hayride:ai/agents@0.0.60#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the imported type alias "hayride:ai/agents@0.0.60#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the imported type alias "hayride:ai/agents@0.0.60#tools".
//
// See [tools.Tools] for more information.
type Tools = tools.Tools

// GraphStream represents the imported type alias "hayride:ai/agents@0.0.60#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// GraphExecutionContextStream represents the imported type alias "hayride:ai/agents@0.0.60#graph-execution-context-stream".
//
...
// OutputStream represents the imported type alias "hayride:ai/agents@0.0.60#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agents@0.0.60#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agents@0.0.60#agent".
//
//	resource agent
