...
// Package agents represents the imported interface "hayride:ai/agents@0.0.62".
package agents
...
// Context represents the imported type alias "hayride:ai/agents@0.0.62#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Format represents the imported type alias "hayride:ai/agents@0.0.62#format".
//
// See [model.Format] for more information.
type Format = model.Format

// Tools represents the imported type alias "hayride:ai/agents@0.0.62#tools".
//
...
// GraphStream represents the imported type alias "hayride:ai/agents@0.0.62#graph-stream".
//
// See [graphstream.GraphStream] for more information.
type GraphStream = graphstream.GraphStream

// GraphExecutionContextStream represents the imported type alias "hayride:ai/agents@0.0.62#graph-execution-context-stream".
//
...
// OutputStream represents the imported type alias "hayride:ai/agents@0.0.62#output-stream".
//
...
// Error represents the imported resource "hayride:ai/agents@0.0.62#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agents@0.0.62#agent".
//
//	resource agent
