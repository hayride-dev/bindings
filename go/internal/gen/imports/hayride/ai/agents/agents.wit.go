...
// Package agents represents the imported interface "hayride:ai/agents@0.0.64".
package agents
...
// Context represents the imported type alias "hayride:ai/agents@0.0.64#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Tools represents the imported type alias "hayride:ai/agents@0.0.64#tools".
//
...
// Error represents the imported resource "hayride:ai/agents@0.0.64#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agents@0.0.64#agent".
//
//	resource agent
