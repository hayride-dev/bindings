...
// Package agents represents the imported interface "hayride:ai/agents@0.0.63".
package agents
...
// Context represents the imported type alias "hayride:ai/agents@0.0.63#context".
//
// See [context.Context] for more information.
type Context = context.Context

// Tools represents the imported type alias "hayride:ai/agents@0.0.63#tools".
//
...
// Error represents the imported resource "hayride:ai/agents@0.0.63#error".
//
//	resource error
...
// Agent represents the imported resource "hayride:ai/agents@0.0.63#agent".
//
//	resource agent
