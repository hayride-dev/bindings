...
// Package wac represents the imported interface "hayride:wac/wac@0.0.62".
package wac
...
// ErrorCode represents the type alias "hayride:wac/wac@0.0.62#error-code".
//
// See [types.ErrorCode] for more information.
type ErrorCode = types.ErrorCode

// Error represents the imported resource "hayride:wac/wac@0.0.62#error".
//
//	resource error
