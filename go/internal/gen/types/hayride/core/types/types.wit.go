...
// Package types represents the imported interface "hayride:core/types@0.0.60".
package types
...
// ThreadMetadata represents the type alias "hayride:core/types@0.0.60#thread-metadata".
//
// See [threads.ThreadMetadata] for more information.
type ThreadMetadata = threads.ThreadMetadata

// ThreadStatus represents the type alias "hayride:core/types@0.0.60#thread-status".
//
// See [threads.ThreadStatus] for more information.
type ThreadStatus = threads.ThreadStatus

// Message represents the type alias "hayride:core/types@0.0.60#message".
//
// See [types.Message] for more information.
type Message = types.Message

// Cast represents the record "hayride:core/types@0.0.60#cast".
//
//	record cast {
//		name: string,
//		function: string,
...
// Generate represents the record "hayride:core/types@0.0.60#generate".
//
//	record generate {
//		model: string,
//		system: string,
...
// RequestData represents the variant "hayride:core/types@0.0.60#request-data".
//
...
// ResponseData represents the variant "hayride:core/types@0.0.60#response-data".
//
...
// Request represents the record "hayride:core/types@0.0.60#request".
//
//	record request {
//		data: request-data,
...
// Response represents the record "hayride:core/types@0.0.60#response".
//
//	record response {
//		data: response-data,
//		error: string,
