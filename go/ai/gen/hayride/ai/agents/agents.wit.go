...
// Package agents represents the exported interface "hayride:ai/agents@0.0.29".
package agents
...
// Agent represents the type alias "hayride:ai/agents@0.0.29#agent".
//
// See [types.Agent] for more information.
type Agent = types.Agent

// Tool represents the type alias "hayride:ai/agents@0.0.29#tool".
//
// See [types.Tool] for more information.
type Tool = types.Tool

// ErrorCode represents the enum "hayride:ai/agents@0.0.29#error-code".
//
//	enum error-code {
//		enhance-error,
//		unknown
...
// Error represents the exported resource "hayride:ai/agents@0.0.29#error".
//
//	resource error
