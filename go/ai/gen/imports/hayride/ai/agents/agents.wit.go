...
// Package agents represents the imported interface "hayride:ai/agents@0.0.34".
package agents
...
// Agent represents the type alias "hayride:ai/agents@0.0.34#agent".
//
// See [types.Agent] for more information.
type Agent = types.Agent

// Tool represents the type alias "hayride:ai/agents@0.0.34#tool".
//
// See [types.Tool] for more information.
type Tool = types.Tool

// ErrorCode represents the enum "hayride:ai/agents@0.0.34#error-code".
//
//	enum error-code {
//		enhance-error,
//		unknown
...
// Error represents the imported resource "hayride:ai/agents@0.0.34#error".
//
//	resource error
