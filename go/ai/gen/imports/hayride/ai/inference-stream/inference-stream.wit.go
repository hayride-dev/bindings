...
// Package inferencestream represents the imported interface "hayride:ai/inference-stream@0.0.33".
...
// Error represents the imported type alias "hayride:ai/inference-stream@0.0.33#error".
//
// See [errors.Error] for more information.
type Error = errors.Error

// Tensor represents the imported type alias "hayride:ai/inference-stream@0.0.33#tensor".
//
// See [tensor.Tensor] for more information.
type Tensor = tensor.Tensor

// TensorStream represents the imported type alias "hayride:ai/inference-stream@0.0.33#tensor-stream".
//
// See [tensorstream.TensorStream] for more information.
type TensorStream = tensorstream.TensorStream

// NamedTensor represents the imported tuple "hayride:ai/inference-stream@0.0.33#named-tensor".
//
...
// NamedTensorStream represents the imported tuple "hayride:ai/inference-stream@0.0.33#named-tensor-stream".
//
//	type named-tensor-stream = tuple<string, tensor-stream>
type NamedTensorStream cm.Tuple[string, TensorStream]

// GraphExecutionContextStream represents the imported resource "hayride:ai/inference-stream@0.0.33#graph-execution-context-stream".
//
