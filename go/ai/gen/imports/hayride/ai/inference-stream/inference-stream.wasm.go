...
//go:wasmimport hayride:ai/inference-stream@0.0.31 [resource-drop]graph-execution-context-stream
//go:noescape
func wasmimport_GraphExecutionContextStreamResourceDrop(self0 uint32)

//go:wasmimport hayride:ai/inference-stream@0.0.31 [method]graph-execution-context-stream.compute
//go:noescape
