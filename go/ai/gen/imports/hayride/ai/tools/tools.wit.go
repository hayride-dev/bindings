...
// Package tools represents the imported interface "hayride:ai/tools@0.0.32".
package tools
...
// Pollable represents the imported type alias "hayride:ai/tools@0.0.32#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Tool represents the type alias "hayride:ai/tools@0.0.32#tool".
//
// See [types.Tool] for more information.
type Tool = types.Tool

// ErrorCode represents the enum "hayride:ai/tools@0.0.32#error-code".
//
//	enum error-code {
//		invalid-argument,
//		missing-function,
...
// Error represents the imported resource "hayride:ai/tools@0.0.32#error".
//
//	resource error
...
// FutureResult represents the imported resource "hayride:ai/tools@0.0.32#future-result".
//
